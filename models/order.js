...
Order.findByStatus = (status, statusDos) => {
    ...
    SELECT 
		...
		JSON_AGG(
			JSON_BUILD_OBJECT(
                ...
                'cantExtra1', OHP.cantExtra1,
                'cantExtra2', OHP.cantExtra2,
                'cantExtra3', OHP.cantExtra3,
                'extra1',extra1,
                'extra2',extra2,
                'extra3',extra3,
                'extprecio1',extprecio1,
                'extprecio2',extprecio2,
                'extprecio3',extprecio2
			)
		) AS products,
        JSON_BUILD_OBJECT(
            'id', U.id,
    ...
    return db.manyOrNone(sql, [status, statusDos]);
